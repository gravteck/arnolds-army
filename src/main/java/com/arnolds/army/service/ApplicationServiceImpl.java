...
public class ApplicationServiceImpl implements ApplicationService {
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#findTeam(java.lang.Integer)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#saveTeam(com.arnolds.army. model.Team)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#removeTeam(java.lang.Integer)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#findPlayer(java.lang.Integer)
   */
  @Override
  // @Cacheable("player")
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#findSeason(java.lang.Integer)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#saveSeason(com.arnolds.army. model.Season)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#removeSeason(java.lang. Integer)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#findGame(java.lang.Integer)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#saveGame(com.arnolds.army. model.Game)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#removeGame(java.lang.Integer)
   */
  @Override
  @Transactional
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#findStatisticalYear(java.lang .Integer)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see com.arnolds.army.service.ApplicationService#removeStatisticalYear(java. lang.Integer)
   */
  @Override
  @Transactional
  ...
  public List<Game> findAllGames() {
    ...
    return gameDao.findAll().stream()
        .sorted((a, b) -> a.getLocalDateTime().compareTo(b.getLocalDateTime()))
        .collect(Collectors.toList());
  }
  ...
  public List<StatisticalYear> findAllStatisticalYears() {
    ...
    return statisticalYearDao.findAll().stream()
        .sorted((a, b) -> a.getYear().compareTo(b.getYear())).collect(Collectors.toList());
  }
