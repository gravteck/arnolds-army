...
public class EditableField {
	...
	public EditableField(String label, String field, String data, String placeholder, boolean password, boolean email) {
		this.label = label;
		this.field = field;
		this.data = data;
		this.placeholder = placeholder;
	...
	public static EditableField field(String label, String field, String data, String placeholder, boolean password,
			boolean email) {
